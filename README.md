...
```
Alberda, G. & Hentschel, J. (2024). A digital edition of the 389 Chorale Settings (Choralgesänge) by J.S. Bach (v2.4) [Data set]. Zenodo. https://doi.org/10.5281/zenodo.11358762
```
...
* `Measure numbers`: In these scores the measure numbers changed from `v1.0` to `v2.4`.
